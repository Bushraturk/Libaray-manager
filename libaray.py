...
class BookCollection:
    ...
    def __init__(self):
        """Intialize a new book collection with an empty list and set up file storage."""
        self.book_list = []
    ...
    def find_book(self):
        ...
        if found_books:
            ...
            for index, book in enumerate(found_books,1):
                ...
                print(
                    f"f{index}. {book['author']} ({book['year']}) - {book['genre']} -{reading_status}"
                ) 
        else:
    ...
    def start_application(self):
        ...
        while True:
            ...
            if user_choice == "1":
                ...
                self.save_to_file()
                print("Thank you for using Book Collection Manager. Goodbyyyye!")
                break
            else:
